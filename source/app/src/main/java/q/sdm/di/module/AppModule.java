...
import q.sdm.data.AppRepository;
import q.sdm.data.Repository;
import q.sdm.data.local.prefs.AppPreferencesService;
import q.sdm.data.local.prefs.PreferencesService;
import q.sdm.data.local.sqlite.AppDatabase;
import q.sdm.data.local.sqlite.AppDbService;
import q.sdm.data.local.sqlite.DbService;
import q.sdm.data.remote.ApiService;
import q.sdm.data.remote.AuthInterceptor;
import q.sdm.di.qualifier.ApiInfo;
import q.sdm.di.qualifier.DatabaseInfo;
import q.sdm.di.qualifier.PreferenceInfo;
